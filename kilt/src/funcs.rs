...
use keeper_primitives::{
    Decode, Hash, VerifyResult, TIMEOUT_DURATION,
};
use super::*;
use super::types::{KiltClient};
use std::time::Duration;
use sp_core::H256;
pub use task::task_attestation;
use tokio::time::{timeout_at, Instant};
use crate::error::Error;
// todo: move those to kilt
use keeper_primitives::kilt::Attestation;
use super::types::{KILT_LOG_TARGET, KILT_MAX_RETRY_TIMES};
use crate::utils::get_attestation_storage_key;
...
pub async fn filter(client: &KiltClient, result: Vec<VerifyResult>) -> Result<Vec<VerifyResult>> {
    ...
    for i in result {
        ...
        let maybe_attest = maybe_attest.map_err(|e| (i.number, e))?;
...
mod tests {
    ...
    use crate::funcs::query_attestation;
    use crate::types::KiltClient;
